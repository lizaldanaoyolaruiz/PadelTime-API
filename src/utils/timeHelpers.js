...
export const getBlockedHoursPerWeek = (blockouts, openingDays, openTime, closeTime) => {
    const totalBlockedMinutes = blockouts.reduce((acc,block) => {
        return acc + getBlockedMinutesForBlock(block,openingDays, openTime, closeTime)
    }, 0)
