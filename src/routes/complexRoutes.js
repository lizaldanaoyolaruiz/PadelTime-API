...
import {
  complexRules, complexUpdateRules, complexAdminCreateRules, complexReasonRules,
...
router.patch('/:id/reject', protect, requireRole('superadmin'), complexReasonRules, validate, rejectComplex);
router.patch('/:id/suspend', protect, requireRole('superadmin'), complexReasonRules, validate, suspendComplex);
