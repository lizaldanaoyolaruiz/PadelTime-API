...
router.post('/',    protect, requireRole('admin', 'superadmin'), tournamentRules, validate, createTorneo);
router.put('/:id',  protect, requireRole('admin', 'superadmin'), tournamentRules, validate, updateTorneo);
